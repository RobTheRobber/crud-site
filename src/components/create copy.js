...
export default function Create() {
  ...
  const checkUsername = async (username) => {
    try {
      ...
      // Handle the error, log it, or set appropriate error state
      console.error('Error checking username:', error);
      return false; // Assuming the username is not taken in case of an error
    }
  };
  ...
  return (
    <div>
      <form className="create-form">
        ...
        <button onClick={validateCreation} className="my--button" type="button">Submit</button>
        <Link to="/"><button className="my--button" type="button">Cancel</button></Link>
      </form>
    </div>
  );
}
